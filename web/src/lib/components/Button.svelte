		...
		if (!disabled) {
			...
			if (href) {
				if (href.startsWith('http')) {
					...
					// Internal link, navigate within same tab
...
<style>
	...
	.primary {
		background: #3aafb9;
		box-shadow:
			0px 0px 24px rgba(58, 175, 185, 0.32),
	...
	.primary:hover {
		background: #3aafb9;
		box-shadow:
			0px 0px 24px rgba(58, 175, 185, 0.64),
	...
	.outline:hover {
		background: transparent;
		box-shadow:
			0px 0px 24px var(--caption-basic),
